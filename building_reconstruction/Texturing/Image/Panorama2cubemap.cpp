...
//            param = -right_angle;
            param = right_angle;
//            headingAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(heading) + param, Eigen::Vector3d::UnitY());
//            pitchAngle = Eigen::AngleAxisd(degree_to_radian(pitch), Eigen::Vector3d::UnitZ());
//            rollAngle = Eigen::AngleAxisd(degree_to_radian(roll) - right_angle, Eigen::Vector3d::UnitX());
//            headingAngle = Eigen::AngleAxisd(2*right_angle - degree_to_radian(heading) + param, Eigen::Vector3d::UnitZ());
//            pitchAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(pitch), Eigen::Vector3d::UnitY());
//            rollAngle = Eigen::AngleAxisd(-2*degree_to_radian(roll) + right_angle, Eigen::Vector3d::UnitX());
//            headingAngle = Eigen::AngleAxisd(2*right_angle - degree_to_radian(heading) + param, Eigen::Vector3d::UnitZ());
...
//            param = 2*right_angle;
//            headingAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(heading), Eigen::Vector3d::UnitY());
//            pitchAngle = Eigen::AngleAxisd(degree_to_radian(pitch), Eigen::Vector3d::UnitZ());
//            rollAngle = Eigen::AngleAxisd(degree_to_radian(roll) - right_angle, Eigen::Vector3d::UnitX());
//            headingAngle = Eigen::AngleAxisd(2*right_angle - degree_to_radian(heading) + param, Eigen::Vector3d::UnitZ());
//            pitchAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(pitch), Eigen::Vector3d::UnitY());
...
//            headingAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(heading), Eigen::Vector3d::UnitY());
//            pitchAngle = Eigen::AngleAxisd(degree_to_radian(pitch), Eigen::Vector3d::UnitZ());
//            rollAngle = Eigen::AngleAxisd(degree_to_radian(roll) - right_angle + param, Eigen::Vector3d::UnitX());
//            headingAngle = Eigen::AngleAxisd(-degree_to_radian(heading), Eigen::Vector3d::UnitZ());
//            pitchAngle = Eigen::AngleAxisd(2*right_angle + degree_to_radian(pitch), Eigen::Vector3d::UnitY());
...
//    Eigen::Quaternion<double> q = pitchAngle * headingAngle * rollAngle;
//    m = q.matrix();
